<template>
	<view class="yuanqi-qrcode" :style="{height:canvasSize+'px'}">
		<image v-if="urll" :src="urll" mode="widthFix" class="yuanqi-image"
			:style="{width:canvasSize+'px',height:canvasSize+'px'}">
		</image>
		<canvas :id="canvasId" :canvas-id="canvasId" class="yuanqi-canvas"
			:style="{width:canvasSize+'px',height:canvasSize+'px'}" />
	</view>
</template>
