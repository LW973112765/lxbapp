		...
		<view class="content botton-radius">
			<view class="content-top">
				<view class="content-top-text">
					<text class="">发现新版本 v{{data.version}}</text>
			...
			<view class="content-body">
				...
				<view class="body">
					<scroll-view class="box-des-scroll" scroll-y="true"><rich-text
							:nodes="data.title"></rich-text></scroll-view>
				</view>
	...
	export default {
		data() {
			return {
				...
				data: {
					title: '1. 修复已知问题<br>2. 优化用户体验',
					url: 'https://vkceyugu.cdn.bspapp.com/VKCEYUGU-6bef1fe3-e3e3-4909-9f0c-6ed9bd11c93b/aae2360a-6628-4c93-b873-ce1600b9a852.apk', //安装包下载地址或者通用应用市场地址
					force: 1, //是否强制更新 0代表否 1代表是
					package_type: 0, //0是整包升级 1是wgt升级
					version: '1.0.1' //后端返回的版本名称
				}
			};
		},
			...
			confirm() {
				if (this.data.package_type == 0) {
					...
					if (this.data.url.includes('.apk')) {
						...
						this.data.force = 0; // 解决跳转外部链接后，更新提示还在的问题
						plus.runtime.openURL(this.data.url);
						uni.navigateBack({
							delta: 1
						});
					}
