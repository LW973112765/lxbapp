<template>
	<view class="mainmain">
		...
		<view class="main">
			...
			<!-- 评论我的 -->
			<note-listtwo v-if="navId==2&&comment.length>0" :list="comment" :threshold="threshold" :options="options">
				<template slot-scope="{item ,index}">
					<view class="recentItem">
			...
			<!-- 留言回复 -->
			<note-listtwo v-if="navId==4&&message.length>0" :list="message" :threshold="threshold" :options="options">
				<template slot-scope="{item ,index}">
					<view class="recentItem">
						<view class="info">
