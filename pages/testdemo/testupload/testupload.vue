<template>
	<view class="tui-container">
		...
		<button type="default" style="margin-top: 30rpx;" @click="chooseVideo">上传视频</button>
		<button type="default" style="margin-top: 30rpx;" @click="showdata">显示</button>
					...
					uni.request({
						...
						success: (res) => {
							...
							if (res.data.status) {
								...
								// 	duration: 2000,
								// });
								if (this.count == this.imageList.length) {
									that.imageList = []
									uni.$emit('deleteimgs')
