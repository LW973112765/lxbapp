									...
									<view class="top">
										...
										<view class="nickanme">
											<view style="font-size: 25rpx;" class="wlw">
												...
												<text v-show="code.senderid == userinfo.id" class="email">我</text><text
													v-if="userinfo.id!=code.senderid&&code.status&&code.isfriend"
													style="font-size: 25rpx;" class="email">朋友</text>
											</view>
	...
	export default {
		...
		mounted() {
			this.commentList.forEach((item, index) => {
				this.getdata(item.senderid, index)
			})
			// setTimeout(() => {
